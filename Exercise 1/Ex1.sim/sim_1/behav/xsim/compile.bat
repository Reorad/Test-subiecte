...
REM
REM Generated by Vivado on Wed May 20 16:09:12 +0300 2026
...
echo "xvhdl --incr --relax -prj simulate_12bit_vhdl.prj"
call xvhdl  --incr --relax -prj simulate_12bit_vhdl.prj -log xvhdl.log
