...
REM
REM Generated by Vivado on Mon May 25 14:21:57 +0300 2026
...
echo "xvhdl --incr --relax -prj Sim_ADD_DIF_vhdl.prj"
call xvhdl  --incr --relax -prj Sim_ADD_DIF_vhdl.prj -log xvhdl.log
