...
REM
REM Generated by Vivado on Thu May 21 18:05:22 +0300 2026
...
echo "xvhdl --incr --relax -prj simulate_coun_reg_vhdl.prj"
call xvhdl  --incr --relax -prj simulate_coun_reg_vhdl.prj -log xvhdl.log
