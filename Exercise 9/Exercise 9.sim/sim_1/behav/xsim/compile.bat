...
REM
REM Generated by Vivado on Fri May 22 12:20:23 +0300 2026
...
echo "xvhdl --incr --relax -prj Alu_simulation_vhdl.prj"
call xvhdl  --incr --relax -prj Alu_simulation_vhdl.prj -log xvhdl.log
