...
REM
REM Generated by Vivado on Thu May 21 12:48:15 +0300 2026
...
echo "xvhdl --incr --relax -prj Simulate_Shift_reg_vhdl.prj"
call xvhdl  --incr --relax -prj Simulate_Shift_reg_vhdl.prj -log xvhdl.log
