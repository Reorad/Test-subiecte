...
REM
REM Generated by Vivado on Fri May 22 00:11:02 +0300 2026
...
echo "xvhdl --incr --relax -prj Simulate_Count_vhdl.prj"
call xvhdl  --incr --relax -prj Simulate_Count_vhdl.prj -log xvhdl.log
